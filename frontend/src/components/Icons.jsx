...
/**
 * SERENITY CUSTOM ICONS
 * Luxury minimal SVG icons (no emojis)
 * All icons follow consistent stroke width and sizing
 */
...
export function ChartIcon({ size = 24, className = '' }) {
  return (
    ...
    >
      ...
      <path d="M7 20V12M12 20V8M17 20V14" />
    </svg>
  );
}
...
export function TrendUpIcon({ size = 20, className = '' }) {
  return (
    <svg
      width={size}
      height={size}
...
export function TrendDownIcon({ size = 20, className = '' }) {
  return (
    <svg
      width={size}
      height={size}
...
export function TrendNeutralIcon({ size = 20, className = '' }) {
  return (
    <svg
      width={size}
      height={size}
...
export function ExpandIcon({ size = 16, className = '' }) {
  return (
    <svg
      ...
      className={className}
    >
      <polyline points="15 9 20 4 20 10" />
      <polyline points="9 15 4 20 10 20" />
      <line x1="20" y1="4" x2="4" y2="20" />
    </svg>
  );
}

export function LoadingSpinnerIcon({ size = 20, className = '' }) {
  return (
    <svg
      width={size}
      height={size}
