    ...
    <>
      ...
      <nav className={styles.navbar}>
        ...
        <div className={styles.navLinks}>
          ...
          <button
            className={`${styles.navLink} ${isActive("/goals") ? styles.active : ""}`}
      ...
      <nav className={styles.mobileNav}>
        ...
        <button
          className={`${styles.mobileTab} ${isActive("/goals") ? styles.mobileActive : ""}`}
          onClick={() => navigate("/goals")}
        >
          <svg
            width="20"
          ...
          <span className={styles.mobileTabLabel}>Goals</span>
        </button>
        <button
